...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::connection('mysql_cove')->create('loaned_vehicles', function (Blueprint $table) {
            $table->id();
            $table->foreignId('requesting_user_id')->constrained('users','id');
            $table->text('loan_reason')->nullable()->comment('motivo del prestamo de la unidad');
    ...
    {
        Schema::connection('mysql_cove')->dropIfExists('loaned_vehicles');
    }
};
