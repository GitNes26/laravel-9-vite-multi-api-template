...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::connection('mysql_becas')->statement("
            ...
            FROM becas as b 
            INNER JOIN users usr ON b.tutor_id=usr.id
            INNER JOIN student_data sd ON b.student_data_id=sd.id
    ...
    {
        DB::connection('mysql_becas')->statement('DROP VIEW IF EXISTS becas_view');
    }
};