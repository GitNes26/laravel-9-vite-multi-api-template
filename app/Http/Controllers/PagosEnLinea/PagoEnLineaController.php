    ...
    public function spPredial_Calculo3(Request $request, Response $response)
    {
        ...
        try {
            ...
            if (isset($dataSend)) {
                ...
                $claveCat = $dataRec["claveCat"];
                $fecha = $dataRec["fecha"];
                $list = PREDIAL::select("EXEC spPredial_Calculo3", [$claveCat, $fecha]);
                $resArr['status'] = true;
    ...
    public function spPredial_GuardaInfConsultaInternet(Request $request, Response $response)
    {
        ...
        try {
            ...
            if (isset($dataSend)) {
                ...
                $list = PREDIAL::select("EXEC spPredial_GuardaInfConsultaInternet", [$claveCat, $nombre, $correo, $telefono]);
                $resArr['status'] = true;
    ...
    public function spPredial_EdoCta(Request $request, Response $response)
    {
        ...
        try {
            ...
            if (isset($dataSend)) {
                ...
                $folio = $dataRec["folio"];
                $list = PREDIAL::select("EXEC spPredial_EdoCta", [$claveCat, $fecha, $usuario, $folio]);
                $resArr['status'] = true;
